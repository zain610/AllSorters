...
<head>
    ...
    <title>Promotional email template <?php echo $this->Html->image('Allsorters_logo.png', array('fullBase' => true, 'alt' => 'AllSorters'));?></title>
</head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#8d8e90">
    <tr>
        <td><table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center">
                ...
                <tr>
                    <td align="center"><a href= "http://yourlink" target="_blank"><img src="images/PROMO-GREEN2_02.jpg" alt="" width="598" height="323" border="0"/></a></td>
                </tr>
                <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="90%" align="center" valign="middle"><font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:12px; line-height:20px; text-transform:uppercase">Lorem Ipsum. Proin gravida nibh vel  auctor aliquet. Aenean sollicitudin,  lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem </font><br />
                                    <font style="font-family:Verdana, Geneva, sans-serif; color:#f58220; font-size:12px; line-height:20px"><a href= "http://yourlink" style="color:#f58220; text-decoration:none"><strong>&lt; view more details &gt;</strong></a></font></td>
                                <td width="5%">&nbsp;</td>
                            </tr>
                        </table></td>
                </tr>
                    ...
                    <td><table width="600" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="175" align="center" valign="top"><table width="175" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" bgcolor="#f58220"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#ffffff; font-size:14px"><strong><a href="http://yourlink" target="_blank" style="color:#ffffff; text-decoration:none">view details</a></strong></font></td>
                                        </tr>
                                        <tr>
