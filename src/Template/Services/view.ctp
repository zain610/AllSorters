...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Services'), ['action' => 'edit', $service->Service_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Services'), ['action' => 'delete', $service->Service_id], ['confirm' => __('Are you sure you want to delete # {0}?', $service->Service_id)]) ?> </li>
        <li><?= $this->Html->link(__('List Services'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Services'), ['action' => 'add']) ?> </li>
...
<div class="service view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            <th scope="row"><?= __('Services Title') ?></th>
            <td><?= h($service->Service_Title) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Services Description') ?></th>
